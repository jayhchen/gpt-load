...
type SystemSettings struct {
	...
	IgnoredErrorStatusCodes      string `json:"ignored_error_status_codes" default:"" name:"config.ignored_error_status_codes" category:"config.category.key" desc:"config.ignored_error_status_codes_desc"`
